	...
	<div class="login">
		<div class="container">
			...
			<form action="RegisterSuccess.jsp" method="post">
				...
				<input type="password" name="check" class="lock" value="Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}">
				...
				<div class="remember">
					<label class="checkbox"><input type="checkbox" name="Checkbox" checked=""><i> </i>我接受条款</label>
				</div>
